...
\textbf{Introduction (current)} - \hyperref[introduction]{Introduction}
- \hyperref[introduction-to-the-project]{Introduction to the problem} -
\hyperref[statistical-equations]{Statistical Equations} -
\hyperref[approaches-explored]{Approaches Explored} -
\hyperref[other-notebooks]{Other notebooks} -
...
\end{align}
    ...
    \hypertarget{approaches-explored}{%
...
model for Poisson dependent variables:
    ...
    \hypertarget{tests-with-real-and-simulated-data}{%
